...
(1, 'aboutus', 'About Us', '       I created the Lost & Found Portal as part of my academic work, driven by a desire to develop a solution that serves a real and recurring need in our communities. As a college student with a strong interest in technology and its applications for social good, I aimed to design a platform that facilitates the reporting and recovery of lost and found items in an organized and user-friendly manner.

This project reflects my commitment to using technology to address everyday challenges while fostering a sense of responsibility and cooperation within society.

It is my hope that this portal not only assists users in recovering their belongings but also contributes positively to the broader goal of building a more connected and considerate community.        <div><br></div>', NULL, NULL, '2024-02-05 07:30:56'),
(2, 'contactus', 'Contact Us', '                        Test Address<div>Chandigarh India</div>', 'info@gmail.com', 9041408545, '2025-08-03 05:40:43');
